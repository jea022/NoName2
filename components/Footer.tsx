          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <FadeSection delay={0.2}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <AnimatedButton className="px-8 py-4 bg-white text-black hover:bg-neutral-100 shadow-xl font-bold rounded-xl text-base">
                  Agendar consulta gratuita
                </AnimatedButton>
                <AnimatedButton className="px-8 py-4 bg-green-500 text-white hover:bg-green-600 shadow-xl font-bold rounded-xl text-base flex items-center justify-center">
